...
## 🧠 High-level sketches of ongoing work
...
| [happy-agent-town](https://github.com/Sharvin-coder/happy-agent-town) · [**live demo**](https://sharvin-coder.github.io/happy-agent-town/) | A living mini-city of 200 agents watched through the glass: memory streams with scored retrieval + reflection (à la Generative Agents), day planning, conversations that shift relationships — and an endogenous growth loop where agents earn wages, sense crowding, propose buildings, vote at town hall, and watch construction open into their future plans. Game-style canvas city (zoom/pan, day/night, follow-cam), deterministic seeded replays, 39 tests |
...
<details>
<summary><b>📏 Evals & benchmarking</b></summary>
<br>
...
<details>
<summary><b>🧮 Representations & theory</b></summary>
<br>
