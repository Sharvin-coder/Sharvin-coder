...
| [glasstown](https://github.com/Sharvin-coder/glasstown) | A behind-the-glass museum of LLM agents: 9 personas in an 11-location town who plan their days, converse, form memories (recency · importance · relevance retrieval + reflection, à la Generative Agents), and drift between relationships — watched live through a canvas viewer with per-agent "exhibit placards". Deterministic seeded replays; runs on a mock backend or Ollama |
